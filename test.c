...
void func(int sockfd)
{
    for (;;)
    {
        MQTT_Packet packet = create_publish_packet("EAFIT/Sede/Poblado/Bloque/33/Salon/301/humedad", "33%");
        MQTT_Packet *publish_packet = &packet;
        write(sockfd, publish_packet, sizeof(MQTT_Packet));
    }
}
